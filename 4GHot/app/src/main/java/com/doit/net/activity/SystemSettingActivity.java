        ...
        for (int i = 0; i < CacheManager.getChannels().size(); i++) {
            ...
            new Timer().schedule(new TimerTask() {
                ...
                public void run() {
                    ...
                    DBChannel dbChannel = ProtocolManager.getCheckedFcn(channel.getBand());
                    if (dbChannel != null && !TextUtils.isEmpty(dbChannel.getFcn())) {
                        ProtocolManager.setChannelConfig(channel.getIdx(), dbChannel.getFcn(), "", "", "", "", "", "");
